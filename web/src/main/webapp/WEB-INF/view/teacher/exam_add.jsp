...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/exam.css">
	...
	<script src="${pageContext.request.contextPath}/static/script/teacher/exam.js"></script>
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-10">
			...
			<div class="row">
				<div class="col-lg-12" id="exam-list">
					<div class="container">
						<!--中间主体部分-->
						<div class="main">
...
<div class="modal_window" id="question_bank">
	<div class="modal_window_title">
		选择题目: <img src="${pageContext.request.contextPath}/static/images/error.png" alt="关闭" id="hide-bank">
	</div>
